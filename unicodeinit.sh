...
rm -rf UCD/
rm -rf Unihan/
wget https://www.unicode.org/Public/zipped/12.0.0/UCD.zip
wget https://www.unicode.org/Public/zipped/12.0.0/Unihan.zip
7z x UCD.zip -oUCD
7z x Unihan.zip -oUnihan
rm UCD.zip
rm Unihan.zip
git add .
git commit -m "UCD and Unihan 12.0.0"
rm -rf UCD/
rm -rf Unihan/
wget https://www.unicode.org/Public/zipped/12.1.0/UCD.zip
wget https://www.unicode.org/Public/zipped/12.1.0/Unihan.zip
7z x UCD.zip -oUCD
7z x Unihan.zip -oUnihan
rm UCD.zip
rm Unihan.zip
git add .
git commit -m "UCD and Unihan 12.1.0"
rm -rf UCD/
rm -rf Unihan/
...
rm Unihan.zip
git add .
git commit -m "UCD and Unihan 13.0.0"
rm -rf UCD/
rm -rf Unihan/
wget https://www.unicode.org/Public/zipped/14.0.0/UCD.zip
wget https://www.unicode.org/Public/zipped/14.0.0/Unihan.zip
7z x UCD.zip -oUCD
7z x Unihan.zip -oUnihan
rm UCD.zip
rm Unihan.zip
git add .
git commit -m "UCD and Unihan 14.0.0"
rm -rf UCD/
rm -rf Unihan/
...
rm Unihan.zip
git add .
git commit -m "UCD and Unihan 15.0.0"
